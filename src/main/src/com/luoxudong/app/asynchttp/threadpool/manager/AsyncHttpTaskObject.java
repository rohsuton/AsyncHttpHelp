...
import com.luoxudong.app.asynchttp.threadpool.ThreadPoolFactory;
import com.luoxudong.app.asynchttp.threadpool.constant.ThreadPoolConst;

/** 
 * ClassName: AsyncHttpTaskObject
 * Description:基本线程任务，统一管理，业务中使用的线程都需要继承该类
 * Create by: 罗旭东
 * Date: 2015年7月13日 上午10:42:59
 */
public class AsyncHttpTaskObject implements Runnable{
	...
	public AsyncHttpTaskObject(int threadPoolType, String threadTaskName){
		initThreadTaskObject(threadPoolType, threadTaskName);
	}
	
	public AsyncHttpTaskObject(int threadPoolType){
