 ...
 * Version: 1.0
 */
package com.luoxudong.app.asynchttp.threadpool.interfaces;

import com.luoxudong.app.asynchttp.threadpool.manager.BaseThreadPool;
...
public interface IThreadPoolManager {
	 ...
	 * @param task 线程任务
	 */
	public void addTask(AsyncHttpTaskObject task);
	 ...
	 * @return 是否移除成功
	 */
	public boolean removeTask(AsyncHttpTaskObject task);
