...
public enum ThreadPoolParams {
	 ...
	 * 文件传输线程池
	 */
	fileHttpThreadPool(ThreadPoolConst.THREAD_TYPE_FILE_HTTP, ThreadPoolConst.DEFAULT_CORE_POOL_SIZE,40,ThreadPoolConst.KEEP_ALIVE_TIME, ThreadPoolConst.DEFAULT_WORK_QUEUE_SIZE, true),
